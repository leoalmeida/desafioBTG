package space.lasf.customer.core.component;
...
import space.lasf.customer.core.exception.ControllerException;
import space.lasf.customer.core.util.ResponseError;
...
class GlobalExceptionHandlerTest {
    ...
    void handleNotFoundExceptionShouldReturnNotFound() {
        ...
        assertEquals("missing customer", body.getError());
    }
